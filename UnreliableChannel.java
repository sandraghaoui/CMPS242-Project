...
public class UnreliableChannel {
    public static void main(String[] args) throws Exception {
        ...
        int port = Integer.parseInt(args[0]);   // listening port
        double p = Double.parseDouble(args[1]); // loss probability
        int minD = Integer.parseInt(args[2]);   // min delay (ms)
        int maxD = Integer.parseInt(args[3]);   // max delay (ms)
        ...
        while (true) {
            ...
            // register new sender if not matched
            if (index == -1) {
